...
namespace Pulsar4X.ECSLib
{
    ...
    {
        public static Dictionary<StringIdentifier, long> CalculateActualMiningRates(Entity colonyEntity)
        {
            Dictionary<StringIdentifier, long> mineRates = colonyEntity.GetDataBlob<MiningDB>().BaseMiningRate.ToDictionary(k => k.Key, v => v.Value);
