...
namespace Pulsar4X.ECSLib
{
    public abstract class EntityCommand
    {
        ...
        [JsonProperty]
        public StringIdentifier CmdID { get; internal set; } = new StringIdentifier("player", Guid.NewGuid().ToString());
        ...
        internal StringIdentifier RequestingFactionGuid { get; set; }
        [JsonProperty]
        /// <summary>
        /// The Entity this command is targeted at
        /// </summary>
        /// <value>The entity GUID.</value>
        internal StringIdentifier EntityCommandingGuid { get; set; }
    ...
    {
        public static bool IsCommandValid(EntityManager globalManager, StringIdentifier factionGuid, StringIdentifier targetEntityGuid, out Entity factionEntity, out Entity targetEntity)
        {
    ...
    {
        internal StringIdentifier FactionGuid;
        internal StringIdentifier EntityGuid;
        ...
        internal CommandReferences(StringIdentifier faction, StringIdentifier entity, IOrderHandler handler, ManagerSubPulse subPulse)
        {
            FactionGuid = faction;
            EntityGuid = entity;
            Handler = handler;
        ...
        public static CommandReferences CreateForEntity(Game game, StringIdentifier entityGuid)
        {
            Entity entity;
