...
namespace Pulsar4X.ECSLib
{
    public static class DefaultStartFactory
    {
        ...
        public static ShipDesign DefaultShipDesign(Game game, Entity faction)
        {
            ...
            ArmorSD plastic = game.StaticData.ArmorTypes[new StringIdentifier("base.armor-types.plastics")];
        ...
        public static ShipDesign SpaceXStarShip(Game game, Entity faction)
        {
            ...
            ArmorSD stainless = game.StaticData.ArmorTypes[new StringIdentifier("base.armor-types.stainless-steel")];
