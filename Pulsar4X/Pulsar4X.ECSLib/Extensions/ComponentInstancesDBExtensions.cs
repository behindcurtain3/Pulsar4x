...
namespace Pulsar4X.ECSLib
{
    public static class ComponentInstancesDBExtensions
    {
        ...
        public static int GetTotalHTK(this ComponentInstancesDB componentInstances)
        {
            ...
            foreach (KeyValuePair<StringIdentifier, List<ComponentInstance>> instance in componentInstances.GetComponentsByDesigns())
            {
        ...
        public static int GetTotalEnginePower(this ComponentInstancesDB instancesDB, out Dictionary<StringIdentifier, double> totalFuelUsage)
        {
            int totalEnginePower = 0;
            totalFuelUsage = new Dictionary<StringIdentifier, double>();
